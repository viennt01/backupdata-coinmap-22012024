...
const items = [
  getItem('My profile', PROFILE_TABS.PROFILE, <SvgUserProfile />),
  getItem('My plans', PROFILE_TABS.PLAN, <SvgLayers />),
  getItem('My payments', PROFILE_TABS.PAYMENT, <SvgCreditCard />),
];
              ...
              <>
                ...
                <div className={style.policy}>
                  <div>
                    ...
                    information with other individuals or organizations without
                    your permission, including public organizations,
                    corporations, or individuals, except when applicable by law.
                  </div>
                </div>
              </>
            )}
