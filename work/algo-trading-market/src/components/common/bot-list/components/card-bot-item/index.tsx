...
export default function CardBotItem({
  ...
  const { toggleProgressModal } = useContext(AppContext);
      ...
      handleUpdateBotStatus(bot, status)
        .then((res) => {
          if (res.error_code === ERROR_CODE.SUCCESS) {
            setBot((prev) => ({ ...prev, user_status: status }));
          }
        })
        .catch((err) => {
  ...
  const renderButton = useCallback(() => {
    ...
    switch (bot.user_status) {
      case BOT_STATUS.NOT_ENOUGH_BALANCE: {
        return (
          <>
            <AppTag content="Not enough balance" type={TagType.WARNING} />
            <ConfigProvider
              theme={{
                token: {
            ...
            >
              <Popconfirm
                ...
                onConfirm={() => handleToggleBot(!checked)}
                okText="Yes"
                cancelText="No"
              >
                <Switch
      ...
      case BOT_STATUS.ACTIVE: {
        return (
          <>
            <AppTag content="Activated" type={TagType.SUCCESS} />
            <ConfigProvider
              theme={{
                token: {
                  colorTextTertiary: COLORS.MULLED_WINE,
      ...
      case BOT_STATUS.INACTIVE: {
        return (
          <>
            <AppTag content="Deactivated" type={TagType.DEFAULT} />
            <ConfigProvider
              theme={{
                token: {
                  colorTextTertiary: COLORS.MULLED_WINE,
      ...
      case BOT_STATUS.CONNECTING: {
        return (
          <>
            <AppTag content="Connecting" type={TagType.INFO} />
          </>
        );
      }
      case BOT_STATUS.PROCESSING: {
        return (
          <>
            <AppTag content="Processing" type={TagType.INFO} />
          </>
        );
      }
      case BOT_STATUS.NOT_CONNECT: {
        return (
          <>
            <AppTag content="Not connected" type={TagType.WARNING_} />
            <Button
      ...
      case BOT_STATUS.DISCONNECTED: {
        return (
          <>
            <AppTag content="Disconnected" type={TagType.ERROR} />
            <Button
              onClick={handleOpenConnectBrokerModal}
              ghost
              style={{
      ...
      case BOT_STATUS.EXPIRED: {
        return (
          <>
            <AppTag content="Expired" type={TagType.ERROR} />
            <Button
      ...
      case BOT_STATUS.INACTIVE_BY_SYSTEM: {
        return (
          <>
            <AppTag content="Inactive by system" type={TagType.ERROR} />
          </>
        );
      }
    }
  }, [bot, handleOpenConnectBrokerModal, handleToggleBot]);
    ...
    <div style={{ width }} className={style.botItemContainer}>
      ...
      <div onClick={onClickBotName} className={style.infoContianer}>
        ...
        <div className={style.contenInfoContainer}>
          ...
          <Row justify={'space-between'}>
            <Col>
              <span className={style.key}>Total trade</span>
            </Col>
            <Col>
          ...
          <Row justify={'space-between'}>
            <Col>
              <span className={style.key}>Profit</span>
            </Col>
            <Col>
              <span
                className={[
          ...
          <Row justify={'space-between'}>
            <Col>
              <span className={style.key}>Gain</span>
            </Col>
            <Col>
              <span
                className={[
          ...
          <Row justify={'space-between'}>
            <Col>
              <span className={style.key}>Balance</span>
            </Col>
            <Col>
