...
import { LoginData, loginMerchant } from './fetcher';
...
export default function LoginPage() {
  ...
  const onFinish = (values: LoginData) => {
    ...
    let queryString = '';
    if (router.query.merchant_code) {
      queryString = `?merchant_code=${router.query.merchant_code}`;
    }

    loginMerchant(data, queryString)
      .then((res) => {
