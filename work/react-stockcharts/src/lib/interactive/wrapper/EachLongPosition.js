...
import DrawLongPosition from "../components/DrawLongPosition";
...
class EachLongPosition extends Component {
  constructor(props) {
    super(props);
  ...
  handleEdgeStopLossDrag(moreProps) {
    ...
    yStopLoss = Math.min(yStopLoss, yEntryStart);
  ...
  handleEdgeTakeProfitDrag(moreProps) {
    ...
    yTakeProfit = Math.max(yTakeProfit, yEntryStart);
...
export default EachLongPosition;
