...
class DonchianSeries extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { bandsYAccessors, bandsOptions, groupId } = this.props;
    ...
    return (
      <>
        ...
        <DonchianLines {...this.props} />
      </>
    );
  }
}

DonchianSeries.propTypes = {
...
export default DonchianSeries;

class DonchianLines extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isHovering: false,
...
DonchianLines.propTypes = DonchianSeries.propTypes;
