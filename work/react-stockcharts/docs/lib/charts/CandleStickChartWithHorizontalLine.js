...
import { HorizontalLine, DrawingObjectSelector } from "react-stockcharts/lib/interactive";
...
const CandleStickChartWithHorizontalLine = fitWidth(CandlestickChart);

export default CandleStickChartWithHorizontalLine;
