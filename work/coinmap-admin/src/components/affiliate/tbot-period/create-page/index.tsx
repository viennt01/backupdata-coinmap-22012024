...
import { FormValues } from '@/components/affiliate/tbot-period/components/create-form';
...
const FaqCreatePage = () => {
    ...
    createNew(_requestData)
      .then((res) => {
        if (res.error_code === ERROR_CODE.SUCCESS) {
          ...
          return router.push(ROUTERS.AFFILIATE_TBOT_PERIOD);
        }
      })
      .catch((e: Error) => {
        errorToast(
  ...
  return (
    <>
      <PageTitle
        title="Create new bot period"
        previousPath={ROUTERS.AFFILIATE_TBOT_PERIOD}
      />
