  ...
  return (
    <div style={{ width: '100%' }} className={style.botDetailContainer}>
      <Row justify="space-between" align="middle">
        <Title>{translate('detail_trading_ai')}</Title>
        ...
        {[BOT_STATUS.ACTIVE].includes(
          botDetailSelected.user_status as BOT_STATUS
        ) && (
          <ConfigProvider
            theme={{
              token: {
        ...
        <div className={style.rightInfoContainer}>
          <Card bordered={false} style={{ minHeight: 300 }}>
            <Title
              ...
              style={{
                textAlign: 'center',
                color: appTheme.colors.on_secondary_darken_1,
              }}
            >
              {`Cumulative PNL`}
            </Title>
            <Line
              ...
              yAxis={{
                grid: null,
                label: {
                  style: { fill: appTheme.colors.on_secondary_darken_1 },
