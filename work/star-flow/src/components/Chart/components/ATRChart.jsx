...
import { ATRSeries } from '@coinmap/react-stockcharts/lib/series';
import {
  MouseCoordinateX,
  MouseCoordinateY,
...
import { GET_ATR_YACCESSORS } from '@/config/consts/settings/atr';

const renderATRChart = ({
  chartId,
  height,
  hPosition,
  fontWeight,
  ...
  const yAccessors = GET_ATR_YACCESSORS(layer.i, input.maType);
